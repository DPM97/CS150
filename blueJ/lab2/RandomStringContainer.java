    ...
    public int search(ArrayList<String> arrayList, String string, ArrayList<String> ogList) {
        ...
        for (int i = 0; i < arrayList.toArray().length; i++) {
            ...
            if (half == string) {
                ...
                //make subarray (first half)
                if (arrayList.toArray().length == 3) {
                    //only happens when starting array is odd - in this case you need to take the correct half of the array
