...
/**
 * The test class MatrixUndirectedWeightedGraphTest.
 *
 * @author  (your name)
 * @version (a version number or a date)
 */
public class MatrixUndirectedWeightedGraphTest
{
    /**
     * Default constructor for test class MatrixUndirectedWeightedGraphTest
     */
    public MatrixUndirectedWeightedGraphTest()
    {
    }
